                ...
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-8">
                      <button
                        type="submit"
                        className="w-full rounded-md bg-[#2F9BAE] px-4 py-3 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#39b4ca] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2F9BAE] transition-colors duration-200"
                      >
                        Send Message
                      </button>
                    </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3" className="border-b border-gray-700">
              ...
              <AccordionContent className="text-base text-gray-400 pb-4">
                We provide services nationwide and have clients across the globe. Our team is fully equipped to work remotely with clients anywhere in the world.
              </AccordionContent>
            </AccordionItem>
